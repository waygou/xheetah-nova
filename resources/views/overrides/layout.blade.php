            ...
            <div class="content">
                ...
                <div data-testid="content" class="px-view py-view mx-auto">
                    ...
                    <p class="mt-8 text-center text-xs text-80">
                        ...
                        &copy; {{ date('Y') }} Xheetah - Courier management system, lovely crafted by Waygou.
                        <span class="px-1">&middot;</span>
                        v{{ Waygou\Xheetah\Models\Configuration::where('code', 'application-version')->first()->value }}
                    </p>
                </div>
            </div>
        </div>
